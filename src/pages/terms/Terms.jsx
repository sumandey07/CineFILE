...
const Terms = () => {
  return (
    <div className="terms container">
      ...
      <div className="para">
        <h4 className="abc">What's covered in these terms</h4>
        <h4 className="bcd">
          We know it's tempting to skip these Terms of Use, but it's important
          to establish what you can expect from us as you use CINEFILE's
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CineFILE.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CineFILE, accessible from{" "}
              <a
                href="https://cine-file.vercel.app/"
        ...
        <ul>
          <li>
            <p>By email: sumankumardey89@gmail.com</p>
          </li>
          <li>
            <p>
