...
const Privacy = () => {
  return (
    <div className="privacy container">
      ...
      <p>
        At CineFILE, accessible from https://cine-file.vercel.app , one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        CineFILE and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in CineFILE. This policy is not applicable to any
      ...
      <p>
        CineFILE follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, CineFILE uses "cookies". These cookies are used
      ...
      <p>
        ...
        advertising partners of CineFILE.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on CineFILE, which are sent
      ...
      <p>
        Note that CineFILE has no access to or control over these cookies that
      ...
      <p>
        CineFILE's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        CineFILE does not knowingly collect any Personal Identifiable
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <a
              href="https://linkedin.com/in/iamsumandey"
              rel="external nofollow noopener"
              target="_blank">
              https://linkedin.com/in/iamsumandey
            </a>
          </p>
        </li>
      </ul>
